...
import (
	...
	"github.com/50HJ/Intelli-Mall/baskets/basketsclient"
	"github.com/50HJ/Intelli-Mall/baskets/basketsclient/basket"
	"github.com/50HJ/Intelli-Mall/baskets/basketsclient/item"
	"github.com/50HJ/Intelli-Mall/baskets/basketsclient/models"
)
...
func (c *basketsFeature) init(cfg featureConfig) (err error) {
	if cfg.useMonoDB {
		c.db, err = sql.Open("pgx", "postgres://intellimall_user:intellimall_pass@localhost:5432/intellimall?sslmode=disable")
	} else {
